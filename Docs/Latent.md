...
### auto Seconds(float Seconds)
### auto UnpausedSeconds(float Seconds)
### auto RealSeconds(float Seconds)
### auto AudioSeconds(float Seconds)
...
### auto UntilTime(float Seconds)
### auto UntilUnpausedTime(float Seconds)
### auto UntilRealTime(float Seconds)
### auto UntilAudioTime(float Seconds)
...
### auto SecondsForActor(AActor* Actor, float Seconds)
### auto UnpausedSecondsForActor(AActor* Actor, float Seconds)
